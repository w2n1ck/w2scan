...
from flask.common.util.string_inject_dic import dic_to_string
from flask.common.exception.poc_exception import PocInfoWrong
from flask.common.exception.poc_exception import PocOptionsWrong
...
class BasePoc(object):
    ...
    def check_config(self):
        ...
        except (PocInfoWrong,PocOptionsWrong), e:
